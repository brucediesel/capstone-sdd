...
- [ ] T001 Verify branch is `012-f6-sfgp-nei`, pyenv `sdd-dev` active, notebook `functions/f6/f6.ipynb` has 47 existing cells (last cell id `a52b2e42`), and data files `data/f6/updated_inputs - Week 7.npy` (27×5) and `data/f6/updated_outputs - Week 7.npy` (27,) exist
